			...
			<div className="row">
						...
						<div className="card-body">
							<div className="d-flex flex-column align-items-center text-center">
								...
								<div className="mt-3">
									...
									<p className="text-muted font-size-sm">{USER_STATE.college}</p>
				...
				<div className="col-lg-8">
                  ...
                  readOnly />
							...
							<div className="row mb-3">
								...
								<div className="col-sm-9 text-secondary">
									<input type="text" className="form-control" value={USER_STATE.college} disabled
                  readOnly />
								</div>
							</div>
							<div className="row mb-3">
              ...
              <div class="row">
						    <div class="col-sm-12">
							    <div class="card">
								    <div class="card-body">
                      <h5 class="d-flex align-items-center mb-3">Friends/ Activities placeholder</h5>
