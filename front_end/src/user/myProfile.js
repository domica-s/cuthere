...
function Profile()  {
  ...
  const onLoadPic = async(e) => {
    ...
    const INITIAL_STATE = {
      ...
      posRating: initialUser.posRating,
      negRating: initialUser.negRating,
    };
					...
					<div className="card mt-3">
						<div className="card-body">
							<div className="d-flex flex-column align-items-center text-center">
								<img src="https://bootdey.com/img/Content/avatar/avatar6.png" id="profile-pic" alt="profile-pic" className="rounded-circle p-1" width="110" height="110" onLoad={onLoadPic}/>
								<div className="mt-3">
									<h4>@{user.username}</h4>
