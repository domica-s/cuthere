      ...
      <Container className="myContainer">
		...
		<div className="main-body"> */}
					...
					<div className="card">
						<div className="card-body">
							<div className="d-flex flex-column align-items-center text-center">
								...
								<div className="mt-3">
									<h4>{USER_STATE.username}</h4>
									<p className="text-secondary mb-1">{USER_STATE.about}</p>
							...
							<ul className="list-group list-group-flush">
								<li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span className="text-secondary">{USER_STATE.country || ""}</span>
								</li>
								<li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span className="text-secondary">{USER_STATE.interests || ""}</span>
								</li>
								<li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span className="text-secondary">{USER_STATE.friends || ""}</span>
								</li>
                				<li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span className="text-secondary">{USER_STATE.rating || ""}</span>
								</li>
								<li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									<h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="0.266667in" height="0.266667in" viewBox="0 0 24 24"><path id="Imported Path" fill="black" fillOpacity="1" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" d="M 5.00,15.00
           C 4.45,15.00 4.00,15.45 4.00,16.00
             4.00,16.55 4.45,17.00 5.00,17.00
             5.55,17.00 6.00,16.55 6.00,16.00
             6.00,15.45 5.55,15.00 5.00,15.00 Z
           M 5.00,11.00
           C 4.45,11.00 4.00,11.45 4.00,12.00
             4.00,12.55 4.45,13.00 5.00,13.00
           ...
           C 9.00,9.00 9.00,4.00 9.00,4.00
             ...
             13.00,22.00 13.00,20.00 13.00,20.00
             13.00,19.45 12.55,19.00 12.00,19.00
             11.45,19.00 11.00,19.45 11.00,20.00
             11.00,20.00 11.00,22.00 11.00,22.00
             11.00,22.00 9.00,22.00 9.00,22.00
             9.00,22.00 9.00,9.00 9.00,9.00 Z
           M 22.00,22.00
           C 22.00,22.00 17.00,22.00 17.00,22.00
             17.00,22.00 17.00,10.00 17.00,10.00
             17.00,10.00 22.00,10.00 22.00,10.00
             22.00,10.00 22.00,22.00 22.00,22.00
             22.00,22.00 22.00,22.00 22.00,22.00 Z" />
</svg> College</h6>
									<span className="text-secondary">{USER_STATE.college || ""}</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div className="col-lg-8 mt-3">
                  ...
                  readOnly />
							...
							<div className="row mb-3">
								...
								<div className="col-sm-9 text-secondary">
									<input type="text" className="form-control" value={USER_STATE.email || ""} disabled
                  readOnly />
								</div>
							</div>
							<div className="row mb-3">
								...
								<div className="col-sm-9 text-secondary">
									<input type="text" className="form-control" value={USER_STATE.mobileNumber || ""} disabled
                  readOnly />
								</div>
							</div>
							<div className="row mb-3">
              ...
              <div className="row">
						    <div className="col-sm-12">
							    <div className="card">
								    <div className="card-body">
                      <h5 className="d-flex align-items-center mb-3">Comment placeholder</h5>
